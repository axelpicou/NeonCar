...
#include "NeonCarOffroadCar.h"
#include "NeonCarOffroadWheelFront.h"
#include "NeonCarOffroadWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"
#include "GameFramework/SpringArmComponent.h"

ANeonCarOffroadCar::ANeonCarOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UNeonCarOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UNeonCarOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UNeonCarOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UNeonCarOffroadWheelRear::StaticClass();
